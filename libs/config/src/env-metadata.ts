...
export const envGroups: EnvGroup[] = [
  ...
  { label: "Security/Tuning", keys: ["ALLOWED_ORIGINS", "RATE_LIMIT_WINDOW_MS", "RATE_LIMIT_MAX_MUTATIONS", "REPAIR_COOLDOWN_MINUTES", "METADATA_ENRICHMENT_MODE", "ANONYMOUS_SHARE_TOKEN_PURGE_DAYS", "APP_CONFIG_ENCRYPTION_KEY", "ANONYMOUS_SHARE_TOKEN_CAP", "ANONYMOUS_SHARE_TOKEN_RETENTION_MS", "USER_PREFERENCES_MAX_BYTES", "POSTGRES_POOL_MAX", "BACKFILL_POSTGRES_POOL_MAX"] },
  {
    label: "Google OAuth",
    keys: [
      "GOOGLE_CLIENT_ID",

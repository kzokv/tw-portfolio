...
export const aiConnectorScopeLabels: Record<LocaleCode, Record<string, string>> = {
  en: {
    ...
    "dividend:write": "Post dividends and other financial writes",
  },
  "zh-TW": {
...
export const chatGptConnectorAuthorizeCopy: Record<LocaleCode, {
  ...
  en: {
    ...
    postingOptIn: "Financial writes are advanced opt-in scopes. Leave them unchecked unless you want this AI client to call guarded write tools such as `post_transaction_draft_rows` or `post_dividend_receipt` after typed or explicit confirmation.",
  ...
  "zh-TW": {
    ...
    postingOptIn: "財務寫入屬於進階自選權限。除非你希望此 AI 客戶端在明確或輸入確認後呼叫受保護的 `post_transaction_draft_rows` 或 `post_dividend_receipt` 等寫入工具，否則請保持未勾選。",

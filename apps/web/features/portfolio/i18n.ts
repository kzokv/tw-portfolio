...
export const portfolioI18n: Record<"en" | "zh-TW", Pick<AppDictionary, "recompute" | "transactions" | "priceHint" | "holdings" | "feeProfiles"> & {
  ...
  en: {
    recompute: {
      ...
      feeModeTitle: "Fee handling",
      keepRecordedTitle: "Keep recorded fees",
      keepRecordedDescription: "Preserve every recorded commission and transaction tax while rebuilding portfolio history.",
      recalculateCalculatedTitle: "Recalculate profile-derived fees",
      recalculateCalculatedDescription: "Reprice only calculated fees. Manual and source-provided fees remain unchanged.",
      reviewImpactAction: "Review impact",
      applyAction: "Apply recompute",
      previewingAction: "Preparing preview…",
      applyingAction: "Recomputing…",
      impactTitle: "Reviewed impact",
      totalCount: "Total trades",
      calculatedCount: "Calculated",
      preservedCount: "Preserved",
      changedCount: "Changed",
      commissionDelta: "Commission delta",
      taxDelta: "Tax delta",
      noFeeChanges: "No recorded fee amounts will change. Derived portfolio history will still be rebuilt.",
      previewRefreshed: "The impact preview changed and was refreshed. Review it before confirming again.",
    },
    transactions: {
      ...
      grossTradeValueLabel: "Gross trade value",
      buyCashOutLabel: "BUY cash out",
      sellNetProceedsLabel: "SELL net proceeds",
      ...
      settlementUnavailableMessage: "Settlement is unavailable until fees are available.",
      ...
      sellAvailabilityLoading: "Checking available to sell…",
      sellAvailabilityReady: "Available to sell: {quantity}",
      sellAvailabilityUseMax: "Use max",
      sellAvailabilityTransportWarning: "Couldn't verify sell availability right now. You can still try submitting.",
      sellAvailabilityUnavailable: "Sell availability can't be verified because the position history can't be replayed.",
      sellAvailabilityOversell: "Requested {requested} exceeds available quantity {available}.",
    },
    priceHint: {
    ...
    holdings: {
      title: "Holdings",
      description: "Aggregated quantity and cost basis by account and ticker.",
      ...
      selectionSummaryCost: "Cost basis",
      ...
      visibleRowsCurrencyDetail: "{currency} holdings",
      accountTerm: "Account",
      tickerTerm: "Ticker",
      quantityTerm: "Quantity",
      currencyTerm: "Currency",
      ...
      pnlTerm: "Unrealized P&L",
      averageCostTerm: "Average cost",
      ...
      noneResults: "No tickers are selected.",
      noResults: "No holdings match the current filters.",
      showingTickers: "Showing {visible} of {total} matching holdings.",
      accountChildLabel: "Account holding",
  ...
  "zh-TW": {
    recompute: {
      ...
      feeModeTitle: "費用處理方式",
      keepRecordedTitle: "保留已記錄費用",
      keepRecordedDescription: "重建投資組合歷史時，保留所有已記錄的手續費與交易稅。",
      recalculateCalculatedTitle: "重新計算依費率產生的費用",
      recalculateCalculatedDescription: "只重新計算系統計算的費用；手動及來源提供的費用維持不變。",
      reviewImpactAction: "檢視影響",
      applyAction: "套用重算",
      previewingAction: "正在準備預覽…",
      applyingAction: "正在重算…",
      impactTitle: "已檢視的影響",
      totalCount: "交易總數",
      calculatedCount: "系統計算",
      preservedCount: "維持不變",
      changedCount: "將變更",
      commissionDelta: "手續費差額",
      taxDelta: "交易稅差額",
      noFeeChanges: "已記錄的費用金額不會變更，但仍會重建投資組合衍生歷史。",
      previewRefreshed: "影響預覽已變更並重新整理。請檢視後再次確認。",
    },
    transactions: {
      title: "新增交易",
      ...
      grossTradeValueLabel: "交易總額",
      buyCashOutLabel: "買入現金流出",
      sellNetProceedsLabel: "賣出淨收入",
      overrideAmountPlaceholder: "覆寫金額（選填）",
      // ui-enhancement — 4 元組條件成立但估算缺值時顯示。
      estimatedUnavailable: "—",
      estimateUnavailableSubLabel: "估算暫不可用",
      settlementUnavailableMessage: "費用可用前無法顯示結算金額。",
      ...
      sellAvailabilityLoading: "正在確認可賣數量…",
      sellAvailabilityReady: "可賣數量：{quantity}",
      sellAvailabilityUseMax: "使用上限",
      sellAvailabilityTransportWarning: "目前無法確認可賣數量，但你仍可嘗試送出。",
      sellAvailabilityUnavailable: "因部位歷史無法重播，無法確認可賣數量。",
      sellAvailabilityOversell: "輸入數量 {requested} 超過可賣數量 {available}。",
    },
    priceHint: {
      exact: "收盤價 • {date}",
      previous: {
    ...
    holdings: {
      title: "持倉",
      description: "依帳戶與代號彙整持倉數量與成本基礎。",
      entries: "{count} 筆",
      selectionLabel: "選取",
      selectionAll: "全部標的",
      selectionSelectedCount: "已選 {count} 檔",
      selectionCount: "已選 {count} 檔",
      selectionNone: "已選 0 檔",
      selectionReset: "重設為全部",
      selectionSelectAll: "全選",
      selectionDeselectAll: "全部取消",
      selectionSearchPlaceholder: "搜尋標的",
      selectionNoMatches: "目前搜尋條件找不到標的。",
      selectionUnavailable: "目前不可用",
      selectionUnavailableHint: "不可用標的會保留在已儲存選取中，直到你移除或重設為全部。",
      selectionRemoveAria: "從已儲存選取移除 {ticker}",
      selectionOpenPickerAria: "開啟標的選取",
      selectionVisibleOfSelected: "顯示 {visible} 檔，共選取 {selected} 檔",
      selectionSummaryCost: "成本基礎",
      selectionSummaryMarketValue: "市值",
      selectionSummaryUnrealizedPnl: "未實現損益",
      selectionSummaryPartial: "部分資料 · 已納入 {included} / {eligible}",
      selectionToggleAria: "切換 {ticker} 的選取狀態",
      ...
      hiddenSortLabel: "目前依{column}{direction}排序",
      customSortLabel: "自訂順序",
      mobileSortDirectionLabel: "切換為{direction}排序",
      mobileSortDirectionUnavailableLabel: "請先選擇排序欄位",
      mobileSortFieldLabel: "排序欄位",
      resetSortLabel: "重設排序",
      sortAscendingLabel: "遞增",
      sortActionTooltip: "將{column}設為{direction}排序",
      sortDescendingLabel: "遞減",
      sortTooltip: "{column}目前為{direction}排序",
      ...
      noneResults: "目前未選取任何標的。",
      noResults: "目前篩選條件沒有符合的持倉。",
      showingTickers: "顯示 {visible} 筆，共 {total} 筆符合條件的持倉。",
      accountChildLabel: "帳戶持倉",
      columnAccounts: "帳戶",
      columnAvgCost: "平均成本",
      columnPrice: "價格",

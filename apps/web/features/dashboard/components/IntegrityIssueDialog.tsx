      ...
      <Dialog.Portal>
        ...
        >
          <div className="mb-3 flex items-start gap-2 text-destructive">
            ...
            <div>
              <Dialog.Title className="text-base font-semibold text-foreground">{dict.dialogs.integrityTitle}</Dialog.Title>
              <Dialog.Description className="text-sm text-muted-foreground">{dict.dialogs.integrityDescription}</Dialog.Description>
            </div>
          </div>

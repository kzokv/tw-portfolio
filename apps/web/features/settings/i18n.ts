...
export const settingsI18n: Record<"en" | "zh-TW", Pick<AppDictionary, "settings"> & {
  ...
  en: {
    settings: {
      ...
      tabSymbols: "Symbols",
      symbolsSectionTitle: "Monitored Symbols",
      symbolsSectionDescription: "Select symbols to monitor. Symbols with open positions are included automatically.",
      symbolsSearchPlaceholder: "Search by ticker or name...",
      symbolsAutoIncludedTitle: "Auto-included from positions",
      symbolsAutoIncludedDescription: "These symbols have open positions and are always monitored.",
      symbolsYourSelectionsTitle: "Your selections",
      symbolsYourSelectionsEmpty: "No symbols selected. Browse the catalog to add symbols.",
      symbolsBrowseCatalog: "Browse full catalog",
      symbolsCatalogTitle: "Instrument Catalog",
      symbolsCatalogBack: "Back to symbols",
      symbolsFilterAll: "All",
      symbolsFilterStock: "Stock",
      symbolsFilterEtf: "ETF",
      symbolsFilterBondEtf: "Bond ETF",
      symbolsSaveSelections: "Save",
      symbolsSaving: "Saving...",
      symbolsSaved: "Selections saved.",
      symbolsSaveError: "Failed to save selections.",
      symbolsPositionLocked: "Active position",
    },
    tooltips: {
  ...
  "zh-TW": {
    settings: {
      ...
      tabSymbols: "追蹤標的",
      symbolsSectionTitle: "追蹤標的",
      symbolsSectionDescription: "選擇要追蹤的標的。有持倉的標的會自動包含。",
      symbolsSearchPlaceholder: "依代號或名稱搜尋...",
      symbolsAutoIncludedTitle: "因持倉自動納入",
      symbolsAutoIncludedDescription: "這些標的有未平倉的持倉，會自動列入追蹤。",
      symbolsYourSelectionsTitle: "你的選擇",
      symbolsYourSelectionsEmpty: "尚未選擇標的。瀏覽目錄以新增追蹤標的。",
      symbolsBrowseCatalog: "瀏覽完整目錄",
      symbolsCatalogTitle: "標的目錄",
      symbolsCatalogBack: "返回追蹤標的",
      symbolsFilterAll: "全部",
      symbolsFilterStock: "股票",
      symbolsFilterEtf: "ETF",
      symbolsFilterBondEtf: "債券 ETF",
      symbolsSaveSelections: "儲存",
      symbolsSaving: "儲存中...",
      symbolsSaved: "選擇已儲存。",
      symbolsSaveError: "儲存選擇失敗。",
      symbolsPositionLocked: "有持倉",
    },
    tooltips: {

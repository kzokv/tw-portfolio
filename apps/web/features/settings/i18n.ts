...
export const settingsI18n: Record<"en" | "zh-TW", Pick<AppDictionary, "settings"> & {
  ...
  en: {
    settings: {
      ...
      displayLayoutDescription:
        "Reset dashboard card order back to the default arrangement.",
      resetLayoutButton: "Reset layout",
      resetLayoutSuccess: "Dashboard layout reset.",
  ...
  "zh-TW": {
    settings: {
      ...
      displayLayoutDescription: "將儀表板卡片順序還原為預設排列。",
      resetLayoutButton: "重設版面",
      resetLayoutSuccess: "已重設儀表板版面。",

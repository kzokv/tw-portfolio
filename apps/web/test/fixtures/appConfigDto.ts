...
const DEFAULT_BOUNDS: AppConfigDto["bounds"] = {
  ...
  yahooJpProviderRateLimitPerMinute: { min: 1, max: 59 },
...
export function buildAppConfigDto(overrides: Partial<AppConfigDto> = {}): AppConfigDto {
  return {
    ...
    effectiveYahooJpProviderRateLimitPerMinute: 60,
    ...
    effectiveTwelveDataProviderMinRequestIntervalMs: 0,
    yahooAuProviderMinRequestIntervalMs: null,
    effectiveYahooAuProviderMinRequestIntervalMs: 0,
    ...
    effectiveYahooJpProviderMinRequestIntervalMs: 0,
    frankfurterProviderMinRequestIntervalMs: null,
    effectiveFrankfurterProviderMinRequestIntervalMs: 0,
    asxGicsProviderMinRequestIntervalMs: null,
    effectiveAsxGicsProviderMinRequestIntervalMs: 0,

    jpCatalogAllowedStockTypes: null,
    effectiveJpCatalogAllowedStockTypes: ["Common Stock", "Preferred Stock", "REIT"],
    jpCatalogIncludeDepositaryReceipts: null,
    effectiveJpCatalogIncludeDepositaryReceipts: false,
    jpCatalogIncludeAtSymbols: null,
    effectiveJpCatalogIncludeAtSymbols: false,

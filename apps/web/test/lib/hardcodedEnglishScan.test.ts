...
const SCAN_TARGETS = [
  ...
  "apps/web/components/ui/LoadingProgressBar.tsx",
  "apps/web/app/portfolio/loading.tsx",
  "apps/web/app/transactions/loading.tsx",
  "apps/web/app/settings/loading.tsx",
  "apps/web/app/reports/loading.tsx",
  "apps/web/app/tickers/[ticker]/loading.tsx",
  "apps/web/app/tickers/[ticker]/error.tsx",

...
export const APP_CONFIG_BOUNDS = {
  ...
  yahooJpProviderRateLimitPerMinute: { min: 1, max: 10_000 },
  ...
  yahooJpProviderMinRequestIntervalMs: { min: 0, max: 60_000 },
  ...
  valuationHealthAbsoluteJpy: { min: 0, max: 1_000_000_000 },

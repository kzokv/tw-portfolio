 ...
 *   H1 — admin: 200 with full shape (4 providers, errorTrail max 10)
...
test.describe("GET /admin/providers", () => {
  test("[H1 admin]: 200 with all 4 providers and DTO shape", async ({
    request,
    providersApi,
  }) => {
    ...
    await providersApi.assert.hasFourProviders(body);

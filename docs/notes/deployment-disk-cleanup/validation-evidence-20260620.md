...
- Outcome: passed. Vitest reported `3` test files passed and `11` tests passed.
...
- Pull request creation must use the repository Linear-ticket waiver path.
- CI must run on the pushed PR branch and be monitored until green.

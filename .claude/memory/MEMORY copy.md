...
## Agent workflow
- [feedback_agent_team_pattern.md](feedback_agent_team_pattern.md) — `/team` skill design: 3 tiers, convergence loop, Architect-as-lead, state file tracking, skill assignments per role

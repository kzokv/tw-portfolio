...
- [feedback_full_test_suite.md](feedback_full_test_suite.md) — "Full tests pass" = all five suites: lint, unit, integration:full:host, test:e2e:bypass:mem, test:e2e:oauth:mem; always use test:integration:full:host not test:integration

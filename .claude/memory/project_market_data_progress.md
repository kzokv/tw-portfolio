...
- KZO-177 (per-provider health UI: `provider_health_log` + `provider_error_log` tables, `providerHealth.ts` service, GET /admin/providers route, AdminProvidersClient responsive table+card, stale-data freshness badges on holdings) — done 2026-05-07

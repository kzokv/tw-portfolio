...
Evaluated and documented in Phase 5d code review (CR-3), 2026-03-27. Example shape updated 2026-04-25 (post-Phase-1f flatten — `el.X.elements.Y` access path no longer exists).

...
- Inspect `docs/004-notes/001-planning/kzo-33-dividend-lifecycle.md` plus future inventory tickets to decide whether the documented zero-cost lot insertion bridge remains acceptable.
